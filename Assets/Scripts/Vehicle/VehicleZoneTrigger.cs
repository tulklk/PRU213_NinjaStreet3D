...
public class VehicleZoneTrigger : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        VehicleMoveToward vehicleTowardScript = GetComponentInParent<VehicleMoveToward>();

        switch (triggerType)
        {
            case TriggerType.MoveZone:
                vehicleTowardScript?.StartMoving();
                break;
            ...
            case TriggerType.KillZone:
                if (other.CompareTag("Player"))
                {
                    ...
                    vehicleTowardScript?.KillPlayer();
                }
